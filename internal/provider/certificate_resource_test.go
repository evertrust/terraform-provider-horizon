		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "subject.0.element", "cn.1"),
					resource.TestCheckResourceAttr(resourceName, "subject.0.type", "CN"),
					resource.TestCheckResourceAttr(resourceName, "subject.0.value", "creation-test-2.com"),
					resource.TestCheckResourceAttr(resourceName, "sans.0.type", "DNSNAME"),
					resource.TestCheckResourceAttr(resourceName, "sans.0.value.0", "creation-2-dns-example.com"),
					resource.TestCheckResourceAttr(resourceName, "sans.0.value.1", "www.creation-2-dns-example.com"),
				),
			},
		},
	})
